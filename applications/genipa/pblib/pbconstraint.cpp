...
PBConstraint::PBConstraint(vector<WeightedLit> const & literals, Comparator comparator, int64_t bound) : leq(0), geq(0), weighted_literals(literals), comparator(comparator)
{
  if (comparator == LEQ)
    leq = bound;
